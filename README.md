...
### Language shift study
Final year project. Used machine learning to predict future trends in Irish language use. Built, compared and contrasted a neural network approach and an epidemiological model approach using SciKitLearn, NumPy, SciPy, matplotlib . Mapped results using Central Statistics Office map data and GeoPandas Python library.

[View Project](https://github.com/Diarmaid-M-H/LanguageProject)
